...
with open('VAC_POSCAR_POSCAR-mp-1522_3x3_Farthest_6_58%.vasp', 'r') as poscar_file:
...
lattice_pbc = [True, True, True]  # Selalu menggunakan periode berulang (periodic boundary conditions)
...
data_dict = {
    ...
    'structure': {
        'numbers': [26] * atom_counts[0] + [16] * atom_counts[1],  # Mengulang nomor atom sesuai dengan jumlah atom masing-masing elemen
        'positions': positions,
        'cell': lattice_matrix,
        'pbc': lattice_pbc
    }
...
df.to_csv('OUT_VAC_POSCAR_POSCAR-mp-1522_3x3_Farthest_6_58%.csv', index=False)
